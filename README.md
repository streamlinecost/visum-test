# Gantt Advanced React demo

This example uses Bryntum Gantt wrapped in the provided BryntumGantt wrapper.
This demo shows how to use Bryntum Gantt in an advanced configuration using React framework
...
check [Online npm repository guide](https://bryntum.com/docs/gantt/#guides/npm-repository.md) for detailed information
...
Please check this  
[Bryntum React integration online guide](https://bryntum.com/docs/gantt#guides/integration/react.md) for
...
* [Bryntum React integration guide](https://bryntum.com/docs/gantt#guides/integration/react.md)
* [Gantt documentation](https://bryntum.com/docs/gantt)
* [Bryntum Gantt Examples](https://bryntum.com/examples/gantt)
* [Bryntum npm repository guide](https://bryntum.com/docs/gantt/#guides/npm-repository.md)
